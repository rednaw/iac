...
- **App-specific security headers** — Done: platform default `app-headers` and `app-buffering`; apps can add CSP/Permissions-Policy in-app or via an extra Traefik middleware (see [Traefik: Adding an application](traefik.md#adding-an-application)).
